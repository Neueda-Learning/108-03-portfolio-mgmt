    ...
    stages {
        ...
        stage('Docker: Build Images') {
            steps {
                ...
                DB_PORT=5173 BACKEND_PORT=8082 FRONTEND_PORT=5763 $COMPOSE_CMD -p ${COMPOSE_PROJECT} build
                DB_PORT=5173 BACKEND_PORT=8082 FRONTEND_PORT=5763 $COMPOSE_CMD -p ${COMPOSE_PROJECT} up -d
