						...
						className={({ isActive }) =>
							[
								...
								isActive
									...
									: 'bg-transparent text-gray-700 hover:bg-[#f4f0ff] hover:border-[#ebe3ff] hover:text-slate-900 font-medium dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:border-slate-700 dark:hover:text-slate-100',
							].join(' ')
						}
					>
